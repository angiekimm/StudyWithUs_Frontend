...
const Modal = ({ selectedData, handleCancel, handleEditSubmit }) => {
  ...
  return (
    <div className="h-screen w-full fixed flex left-0 top-0 justify-center items-center bg-black bg-opacity-70">
      <div className="bg-white rouded shadow-lg w-10/12 md:w-1/3">
        <div className="border-b px-4 py-2 flex justify-between items-center">
          <h3 className="font-semibold text-lg">게시물 수정하기</h3>
